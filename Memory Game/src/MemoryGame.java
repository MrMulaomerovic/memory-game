...
public class MemoryGame extends JFrame implements ActionListener {
    ...
    MemoryGame() {
        ...
        b10.setBounds(10, 130, 50, 40);
        b11.setBounds(70, 130, 50, 40);
        b12.setBounds(130, 130, 50, 40);
        ...
        if (e.getSource() == b12) {
            ...
            if (b9.getLabel().equals(" ")) {
                ...
                if (b1.getLabel().equals("1") && b2.getLabel().equals("2") && b3.getLabel()
                        ...
                        && b11.getLabel().equals("11") && b12.getLabel().equals(" ")) {
    ...
    public static void main(String[] args) {
        ...
        mg.setSize(250, 300);
        mg.setLayout(new GridLayout(4, 3));
        mg.setVisible(true);
